...
📌 2[IntelliJ IDEA](#-IntelliJ-IDEA)<br>
📌 3[Console-Based Input and Output](#-Console-Based-Input-and-Output)<br>
...
By the end of the lesson, you will be familiar with the objects and class work and their purpose. You will also know the different parts of a class – methods, constructors, getters and setters, fields, etc.</p>

| GitHub Chapter Name | Link |
| :- | - |
| Objects and Classes | [To Chapter](https://github.com/SoftUni/Free-Java-Certification-Course/tree/main/01-Getting-Started-with-Java.md) |
...
| GitHub Chapter Name | Link |
| :- | - |
| Defining Classes | [To Chapter](https://github.com/SoftUni/Free-Java-Certification-Course/tree/main/01-Getting-Started-with-Java.md) |
...
| GitHub Chapter Name | Link |
| :- | - |
| OOP Principles | [To Chapter](https://github.com/SoftUni/Free-Java-Certification-Course/tree/main/01-Getting-Started-with-Java.md) |
...
| GitHub Chapter Name | Link |
| :- | - |
| Exception Handling | [To Chapter](https://github.com/SoftUni/Free-Java-Certification-Course/tree/main/01-Getting-Started-with-Java.md) |
...
| GitHub Chapter Name | Link |
| :- | - |
| API Classes | [To Chapter](https://github.com/SoftUni/Free-Java-Certification-Course/tree/main/01-Getting-Started-with-Java.md) |
